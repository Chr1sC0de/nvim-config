...
vim.api.nvim_create_autocmd("FileType", {
	...
	callback = function(event)
		...
		vim.keymap.set("n", "?", "<Plug>(DBUI_Help)", vim.tbl_extend("force", opts, { desc = "DBUI: Help menu" }))

		vim.keymap.set("n", "q", "<Plug>(DBUI_Quit)", vim.tbl_extend("force", opts, { desc = "DBUI: Close drawer" }))
